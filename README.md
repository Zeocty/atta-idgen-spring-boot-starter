...
本项目基于百度开源[uid-generator](https://github.com/baidu/uid-generator)，更改基于springboot3.0及jdk17，实现自动注入和自定义配置，方便使用
...
spring:
  datasource:
    url: jdbc:mysql://a127.0.0.1.top:3306/xxxx?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai
...
atta:
  uid:
  	# DefaultUidGenerator 参数配置，详情参考下方官方文档
    time-bits: 26
    worker-bits: 24
    seq-bits: 13
    epoch-str: 2022-04-22
    # CachedUidGenerator 参数配置
    boost-power: 3
    padding-factor: 50
    schedule-interval:
```
...
private CachedUidGenerator defaultUidGenerator;
...
Snowflake算法
-------------
![Snowflake](https://zerocty-pic.oss-cn-hangzhou.aliyuncs.com/markdown-img/snowflake.png)  
...
![RingBuffer](https://zerocty-pic.oss-cn-hangzhou.aliyuncs.com/markdown-img/ringbuffer.png)  
...
![FalseSharing](https://zerocty-pic.oss-cn-hangzhou.aliyuncs.com/markdown-img/cacheline_padding.png) 
...
![throughput1](https://zerocty-pic.oss-cn-hangzhou.aliyuncs.com/markdown-img/throughput1.png)
...
![throughput1](https://zerocty-pic.oss-cn-hangzhou.aliyuncs.com/markdown-img/throughput2.png)
...
![throughput1](https://zerocty-pic.oss-cn-hangzhou.aliyuncs.com/markdown-img/throughput3.png)