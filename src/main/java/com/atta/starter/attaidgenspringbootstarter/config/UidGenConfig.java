 ...
 * @Title: UidGenConfig
 * @Package com.atta.attaidgenspringbootstater.config
 * @Author: Zeocty
 * @Copyright zeocty@gmail.com
 * @CreateTime: 2023/4/26 15:00
 */
@ComponentScan(basePackages = {"com.atta.starter.attaidgenspringbootstarter"})
...
@MapperScan(value = {"com.atta.starter.attaidgenspringbootstarter.worker.dao"})
