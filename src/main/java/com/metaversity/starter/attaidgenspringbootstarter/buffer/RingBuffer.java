 ...
 */
package com.metaversity.starter.attaidgenspringbootstarter.buffer;

import com.metaversity.starter.attaidgenspringbootstarter.utils.PaddedAtomicLong;
...
public class RingBuffer {
    ...
    protected void discardPutBuffer(RingBuffer ringBuffer, long uid) {
        log.warn("[uid-gen] Rejected putting buffer for uid:{}. {}", uid, ringBuffer);
    }
    ...
    protected void exceptionRejectedTakeBuffer(RingBuffer ringBuffer) {
        log.warn("[uid-gen] Rejected take buffer. {}", ringBuffer);
