 ...
 */
package com.metaversity.starter.attaidgenspringbootstarter.impl;

import com.metaversity.starter.attaidgenspringbootstarter.BitsAllocator;
import com.metaversity.starter.attaidgenspringbootstarter.UidGenerator;
import com.metaversity.starter.attaidgenspringbootstarter.buffer.BufferPaddingExecutor;
import com.metaversity.starter.attaidgenspringbootstarter.buffer.RejectedPutBufferHandler;
import com.metaversity.starter.attaidgenspringbootstarter.buffer.RejectedTakeBufferHandler;
import com.metaversity.starter.attaidgenspringbootstarter.buffer.RingBuffer;
import com.metaversity.starter.attaidgenspringbootstarter.exception.UidGenerateException;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.setBoostPower(uidGenProperties.getBoostPower());
        this.setPaddingFactor(uidGenProperties.getPaddingFactor());
        if(uidGenProperties.getScheduleInterval() != null ) {
            this.setScheduleInterval(uidGenProperties.getScheduleInterval());
        }
        // initialize RingBuffer & RingBufferPaddingExecutor
        this.initRingBuffer();
        log.info("[uid-gen] Initialized RingBuffer successfully.");
    }
    ...
    public long getUID() {
        try {
            ...
            log.error("[uid-gen] Generate unique id exception. ", e);
    ...
    private void initRingBuffer() {
        ...
        log.info("[uid-gen] Initialized ring buffer size:{}, paddingFactor:{}", bufferSize, paddingFactor);
        ...
        log.info("[uid-gen] Initialized BufferPaddingExecutor. Using schdule:{}, interval:{}", usingSchedule, scheduleInterval);
