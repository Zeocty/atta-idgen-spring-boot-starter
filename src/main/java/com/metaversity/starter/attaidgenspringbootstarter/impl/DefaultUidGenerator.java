...
import com.metaversity.starter.attaidgenspringbootstarter.config.UidGenProperties;
import com.metaversity.starter.attaidgenspringbootstarter.exception.UidGenerateException;
import com.metaversity.starter.attaidgenspringbootstarter.utils.DateUtils;
import com.metaversity.starter.attaidgenspringbootstarter.worker.WorkerIdAssigner;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        this.setTimeBits(uidGenProperties.getTimeBits());
        this.setWorkerBits(uidGenProperties.getWorkerBits());
        this.setSeqBits(uidGenProperties.getSeqBits());
        this.setEpochStr(uidGenProperties.getEpochStr());
