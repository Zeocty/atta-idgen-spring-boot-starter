 ...
 */
package com.metaversity.starter.attaidgenspringbootstarter.utils;
...
public abstract class DockerUtils {
    ...
    private static void retrieveFromEnv() {
        ...
        if (hasEnvHost && hasEnvPort) {
            ...
            log.error("[uid-gen] Missing host or port from env for Docker. host:{}, port:{}", DOCKER_HOST, DOCKER_PORT);
